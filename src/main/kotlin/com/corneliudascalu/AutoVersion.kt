...
class AutoVersion {
    ...
    private fun getCommitCountSinceTag(): Int {
        ...
        if (commitDescription.isEmpty() || commitDescription.startsWith("fatal"))
            throw IllegalStateException("No git tags found. Please add at least one tag on the current branch.")
